<main>
    ...
    <div class="card" id="input" style="width: 45rem;">
        ...
        <div class="card-body">
            <h6 id="status">Tambah Jenis Pengaduan</h6>
            <hr style="height: 3px;background-color: #6797ea;">
            <form id="form">
                <input type="hidden" name="kode" id="kode">
                <input type="hidden" name="rcstat" id="rcstat">
                <div class="form-group row">
                    <label class="col-sm-2 form-control-label">Nama jenis pengaduan</label>
                    <div class="col-sm-6">
                ...
                <table id="tabel" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="th-sm">Nama Jenis Pengaduan
                            </th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tabel').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url(); ?>pengaduan/get_tbl_jns_pengaduan",
                "type": "POST"
            },
