...
<body class="fixed-sn light-blue-skin">
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar double-nav">
            ...
            <div class="breadcrumb-dn mr-auto">
                <p>SAPRAS | Universitas Negeri Makassar</p>
            </div>
            ...
            <ul class="nav navbar-nav nav-flex-icons ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="clearfix d-none d-sm-inline-block"><?= $_SESSION['nama'] ?></span>
                    </a>
    ...
    <footer class="page-footer font-small fixed-bottom ">
        ...
        <div class="footer-copyright text-center py-3">© <?= date('Y') ?> Copyright
            <a href="http://ict.unm.ac.id/" target="_blank"> Divisi Programming - UPT TIK - Universitas Negeri Makassar</a>
        </div>
        <!-- Copyright -->
